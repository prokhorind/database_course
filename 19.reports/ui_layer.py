...
def menu():
    while True:
        ...
        if choice == '1':
            ...
            logic_layer.generate_report_logic("pdf")
            print("PDF report generated as 'officer_report.pdf'.")
        elif choice == '7':
            logic_layer.generate_report_logic("xlsx")
            print("Excel report generated as 'officer_report.xlsx'.")
        elif choice == '8':
            print("Goodbye!")
            break
        else:
